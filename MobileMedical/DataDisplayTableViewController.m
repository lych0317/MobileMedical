...
#define DisplaySelectedSegue @"DisplaySelectedSegue"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self performSegueWithIdentifier:DisplaySelectedSegue sender:[AppModel sharedAppModel].staffModels[indexPath.row]];
}

#pragma mark - Navigation

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:DisplaySelectedSegue]) {
        DisplaySelectedTableViewController *viewController = segue.destinationViewController;
